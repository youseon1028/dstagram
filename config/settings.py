...
SECRET_KEY = '=jn*@8ubefi&#cisn)g)65u^yk%nb=nz-f-y!vgihyp!ir^hw+'
...
DATABASES['default'].update(dj_database_url.config(conn_max_age=500)) # DATABASES 밑에다가 꼭 추가
...
DISQUS_WEBSITE_SHORTNAME = 'dstagram1-youseon1028'

SITE_ID = 1

AWS_ACCESS_KEY_ID = 'AKIARGY2UZMBDWZQKCUT'
AWS_SECRET_ACCESS_KEY = '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'
AWS_REGION = 'ap-northeast-2'
AWS_STORAGE_BUCKET_NAME = 'dstagram-youseon1028'
